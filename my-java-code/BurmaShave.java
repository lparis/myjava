...
{ // Class body open
	...
	{ 
		...
		JOptionPane.showMessageDialog(null, "Burma-Super-Shave");
		// Produces fifth dialog with last line of the slogan.
		
		JOptionPane.showMessageDialog(null, "Not to be confued with Burma-Super-Star");
		// Produces last dialog with made up line.
	}
